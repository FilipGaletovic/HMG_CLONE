  ...
  return (
    <>
      <div className="navBar" id="navbar" ref={navRef}>
        <div className="navLogo__invisible"></div>
        ...
        <div className="subNav">
          ...
          <div
            className="subNav-content contentProduct"
            id="subnav__contnentProduct__Invisible"
          >
        ...
        <div className="subNav">
          ...
          <div
            className="subNav-content contentService"
            id="subnav__contnentService__Invisible"
          >
